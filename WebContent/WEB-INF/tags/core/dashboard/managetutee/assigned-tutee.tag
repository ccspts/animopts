...
<div class="panel-group" id="assignedAccordion">
    <!-- Tutee Item -->
    <div id="assignedTutorPane" class="panel panel-default">
        <c:forEach var="requestTutor" items="${assignedList}">
        <div class="panel-heading" data-toggle="collapse" data-parent="#assignedAccordion" data-target="#${requestTutor.id}">
            <h4 class="panel-title">
            <img class="avatar-small" src="<c:url value="/img/no_avatar.jpg" />">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#assignedAccordion" href="#collapse1">
